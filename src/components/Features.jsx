const Features = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-1">
      ...
      <div className="p-6 rounded-lg shadow-lg bg-blue-600 text-white">
        ...
        <p className="text-gray-300">
          ...
          assignment details, deadlines, and requirements with our user-friendly
          interface.
        </p>
      </div>
      ...
      <div className="p-6 rounded-lg shadow-lg bg-blue-600 text-white">
        ...
        <p className="text-gray-300">
          Streamline the process of collecting and managing student submissions.
          Organize assignments, track deadlines, and provide feedback all in one
          place.
        </p>
      </div>
      ...
      <div className="p-6 rounded-lg shadow-lg bg-blue-600 text-white">
        ...
        <p className="text-gray-300">
          ...
          Enhance the learning experience with detailed comments and grades for
          each submission.
        </p>
      </div>
    </div>
